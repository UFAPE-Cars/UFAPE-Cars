...
class VendedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendedor" do
    assert_difference("Vendedor.count") do
      post vendedors_url, params: { vendedor: { comissao: @vendedor.comissao, cpf: @vendedor.cpf, idade: @vendedor.idade, nome: @vendedor.nome } }
    end
  ...
  test "should update vendedor" do
    patch vendedor_url(@vendedor), params: { vendedor: { comissao: @vendedor.comissao, cpf: @vendedor.cpf, idade: @vendedor.idade, nome: @vendedor.nome } }
